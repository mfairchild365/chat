...
<form action="<?php echo \Chat\Config::get('URL')?>" method="post" class="form-horizontal">
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" id="input-firstname" name="first_name" placeholder="First Name" value="<?php $context->first_name?>" />
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="input-lastname">Last Name</label>
        <div class="controls">
            <input type="text" id="input-lastname" name="last_name" placeholder="Last Name" value="<?php $context->first_name?>" />
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="input-email">Email</label>
        <div class="controls">
            <input type="email" id="input-email" name="email" required placeholder="Email" value="<?php $context->email?>" />
        </div>
    </div>
    <div class="control-group">
